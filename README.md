...
I'm a passionate software developer and 3D artist. Experienced in application (especially games) and web development as well as design.

<br>

- I've worked on: [Crumbling City (VR/PC Game)](https://store.steampowered.com/app/1520290/Crumbling_City/), [Pine (Java game engine)](https://pine.prozilla.dev/)
- My portfolio: [prozilla.dev](https://prozilla.dev/)
- Contact me: business@prozilla.dev
- Support my work: [ko-fi.com/prozilla](https://ko-fi.com/prozilla)
